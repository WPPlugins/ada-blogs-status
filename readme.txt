...
Plugin URI: http://1uthavi.adadaa.com/ada-blogs-sites-status/
Author: CAPitalZ
...
Please leave any suggestions to improve or bugs on my blog : [Ada Blogs Status](http://1uthavi.adadaa.com/ada-blogs-sites-status/)
...
There is a deprecated version of the plugin with 3 seperate widgets available at [Ada List All](http://1uthavi.adadaa.com/new-updated-active-blogs-widgets/)

== Screenshots ==

1. See live example at [அட‌டா](http://adadaa.com/)
